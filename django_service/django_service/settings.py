...
SECRET_KEY = 'django-insecure-5x+zt7*_#xb4nv_24%9264amz_kn9cl79-4i8rvy&%swu8^lt9'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        # token bearer:
        'authorize.authentication.BearerTokenAuthentication',
    ),
